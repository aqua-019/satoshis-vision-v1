...
function SedCard({ title, right, children, pad = "14px 16px", style }) {
  return (
...
function SedColumn({ data, w = 360, h = 624 }) {
...
/* ── live tx feed ───────────────────────────────────────────── */
function SedTxFeed({ data, onPickTx }) {
...
function SedOverview({ data, onPickTx }) {
