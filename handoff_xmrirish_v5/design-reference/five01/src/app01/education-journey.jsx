// education-journey.jsx — /education (default) · the BTC → XMR narrative
// Ten chapters: genesis → Satoshi's privacy problem → Bitcoin upgrades →
// Monero → the technology → the comparison → the controversy → Wagyu →
// self-custody → the choice. Content editorial; verify before publishing.

/* local helpers — prefixed Jrn to avoid shared-scope collisions */
function JrnHero({ navigate }) {
  return (
...
function JrnTechCard({ name, protects, color, children }) {
  return (
