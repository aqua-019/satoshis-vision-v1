// education-timeline.jsx — /education/timeline
// The privacy-evolution timeline: ~48 events across 5 eras, filterable by
// category (Bitcoin · Monero · Crossover · Regulatory). Content editorial.
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 26 }}>
      ...
      <section style={{ display: "flex", gap: 28, alignItems: "center", flexWrap: "wrap" }}>
        {[[total, "Events"], [18, "Years"], [5, "Eras"]].map(([v, k], i) => (
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 6, flexWrap: "wrap" }}>
          {["all", ...Object.keys(TL_CAT)].map((k) => {
            const on = filter === k;
            const color = k === "all" ? "var(--ink-100)" : TL_CAT[k].color;
            return (
...
window.EduTimeline = EduTimeline;
