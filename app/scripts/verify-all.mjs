...
const PHASES = [
  { n: 0, name: 'build', needsServer: false, cmds: NO_BUILD ? [] : ['tsc --noEmit', 'npm run build'] },
  {
    ...
    cmds: [
      ...
      'node ../api/_tests/verify-nodehealth.mjs',
      'node ../api/_tests/verify-tx-parse.mjs',
      'node ../api/_tests/verify-feeds.mjs',
      'node ../api/_tests/verify-releases-pipe.mjs',
      'node ../api/_tests/verify-markets.mjs',
      'node ../api/_tests/verify-status.mjs',
      'node ../api/_tests/verify-nodes.mjs',
