...
function ChamberPanel({ side, tick, phase }) {
...
function ChamberMath({ phase, tick }) {
        ...
        <svg viewBox="0 0 220 320" width="220" height="320">
          <defs>
            ...
            <radialGradient id="chamberCore">
              <stop offset="0%" stopColor="#fff1e0" stopOpacity="0.9" />
...
window.StealthView = StealthView;
