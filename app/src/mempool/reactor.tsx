                      ...
                      <div>
                        ...
                        {isTracked ? (
                          <div className="mono" style={{ marginTop: 4, textAlign: "center" }}>
                            <div style={{ fontSize: 12, color: "var(--y-50)", lineHeight: 1 }}>▲</div>
                ...
                >
                  <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6, fontFamily: "var(--f-mono)", fontSize: 10 }}>
                      ...
                      <div className="dim" style={{ fontSize: 9 }}>fee/B histogram · {histCaption}</div>
                    </div>
                  </div>
                </PanelFrame>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "120px 1fr 90px 110px 110px 90px 60px", gap: 12, fontFamily: "var(--f-mono)", fontSize: 11 }}>
                  ...
                  {data.mempool.slice(0, 7).map((tx) => {
                    ...
                    <React.Fragment key={tx.id}>
                      ...
                      <div className="hash" data-tracked-tx={trackedTxIdFor(tracking) === tx.id ? tx.id : undefined} onClick={() => onPickTx(tx.id)} style={{ fontSize: 10.5, cursor: "pointer" }}>{tx.id.slice(0, 12)}…{tx.id.slice(-10)}</div>
