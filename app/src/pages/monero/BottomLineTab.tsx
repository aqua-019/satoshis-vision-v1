/**
 * pages/monero/BottomLineTab.tsx — Monero investment thesis: the great divergence,
 * the failed-tracing evidence record, the cryptographic architecture, the delisting paradox.
 * Ported from five01 bottom-line.jsx → MoneroBottomLine. Editorial content — verify figures before publishing.
 */

import * as React from "react";
import { PageHeader } from "@/layout/AppShell";
import { Card } from "@/design/primitives";
import { EduChapter } from "@/pages/_education/EduAtoms";
...
function BtmEvidenceCard({ amount, who, when, outcome, otone, children }: {
  amount: React.ReactNode; who: React.ReactNode; when: React.ReactNode;
  outcome: React.ReactNode; otone: string; children: React.ReactNode;
}) {
  return (
...
function BtmArchGrid() {
  const PRIMS: [string, string, string, string][] = [
...
/* ══ BOTTOM LINE TAB ════════════════════════════════════════ */
export function BottomLineTab({ data }: MoneroTabProps) {
